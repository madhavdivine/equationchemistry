...
import reactants from './images/fifth-reactants.png';
function Que5() {
      ...
      <div className="containerr">
        ...
        <div className="subcontainer1">
          <div className="equationdiv">
            ...
            Fe + CuCl<span className="subdiv">2</span>   
            <img src={Arrow}/>
            
            FeCl<span className="subdiv">2</span> + Cu 
            </span>
        ...
        <Link to='/' className="correctans"> Next <img src={whiteArrow}/> </Link>
        }
...

  {
    ...
    <div className="alertcongrats">
        <div className="congratssub">
    <span>Congratulation!</span>
      <p> You have successfully chosen the 
        correct limiting reactants!
      </p>
