...
import reactants from './images/sixth-reactants.png';
function Que3() {
      ...
      <div className="containerr">
        ...
        <div className="subcontainer1">
          <div className="equationdiv">
            ...
            4Fe + 3O<span className="subdiv">2</span>   
            <img src={Arrow}/>
            
            2Fe<span className="subdiv">2</span>O<span className="subdiv">3</span> 
            </span>
        ...
        <Link to='/Que4' className="correctans"> Next <img src={whiteArrow}/> </Link>
        }
